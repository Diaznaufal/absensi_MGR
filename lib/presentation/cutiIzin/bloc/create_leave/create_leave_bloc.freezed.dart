...
class _CreateLeave implements CreateLeaveEvent {
  ...
  int get hashCode => Object.hash(runtimeType, leaveTypeId, startDate, endDate,
      reason, inputAt, totalDays, type, attachment);

  @override
  String toString() {
    return 'CreateLeaveEvent.createLeave(leaveTypeId: $leaveTypeId, startDate: $startDate, endDate: $endDate, reason: $reason, inputAt: $inputAt, totalDays: $totalDays, type: $type, attachment: $attachment)';
  }
}
