...
/// Adds pattern-matching-related methods to [GetUserEvent].
extension GetUserEventPatterns on GetUserEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case _GetUser() when getUser != null:
...
class _GetUser implements GetUserEvent {
  const _GetUser();
...
class _Loading implements GetUserState {
  const _Loading();
...
class _Error implements GetUserState {
